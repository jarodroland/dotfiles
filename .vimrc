...
" Using iTerm2? Go-to preferences / profile / colors and disable the smart
" bar cursor color. Then pick a cursor and highlight color that matches your
" theme. That will ensure your cursor is always visible within insert mode.
